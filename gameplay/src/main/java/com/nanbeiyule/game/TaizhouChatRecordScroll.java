...
final class TaizhouChatRecordScroll {
    static final float VIEW_TOP = TaizhouWaitingToolLayout.CHAT_CONTENT.top();
    static final float VIEW_BOTTOM = TaizhouWaitingToolLayout.CHAT_CONTENT.bottom();
    static final float ROW_HEIGHT = 145.0f;
    static final float ROW_TOP = VIEW_TOP + ROW_HEIGHT / 2.0f;
    ...
    int messageAt(float y) {
        ...
        int index = (int) ((y - VIEW_TOP + offset) / ROW_HEIGHT);
